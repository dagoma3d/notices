      ...
      <div className="wrap row margin-bottom-shop">
        <div className="col-xl-24 row container-interface">
          ...
          <div className="zone" data-top="70%" data-left="93%" data-name={t("Préparer l'impression")}>
            {t("En cliquant sur \"Préparer l'impression\" vous allez valider votre préparation.")}<br />
            {t("Si une carte SD est déjà dans le lecteur, le fichier s'enregistre directement dessus. Sinon, une boîte de dialogue s'ouvre pour choisir l'emplacement d'enregistrement.")}<br />
            {t("Le fichier s'enregistre sous le nom \"dagoma0.g\" c'est le seul nom de fichier qui permet de démarrer une impression.")}
          </div>

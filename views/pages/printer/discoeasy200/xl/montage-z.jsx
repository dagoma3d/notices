  ...
  return (
    <Layout t={t}>
      ...
      <Section
        ...
        content={[
          { text: "20.1 - Mise en place des barres verticales", classes: "big-title tleft", tag: "h2" },
      ...
      <Section
        t={t}
        flip={true}
        media={{ id: "cX--8Vfg7RI", type: "yt" }}
        content={[
          { text: "20.2 - installation du chariot de X", classes: "big-title tleft", tag: "h2" },
          { text: "Faites glissez l'ensemble du chariot de X vers le bas. Attention, il est important de bien remettre les anti-wooble vers l'arrière comme montré dans la vidéo." }
        ]} />
      <Section
        t={t}
        media={{ id: "OsKe_OkfhaE", type: "yt" }}
        content={[
          { text: "20.3 - Vissage des tiges filetées", classes: "big-title tleft", tag: "h2" },
          { text: "Ensuite, vissez les deux tiges filetées dans leurs emplacements." }
        ]} />
      <Section
        t={t}
        flip={true}
      ...
      <Block
        ...
        <Validation t={t} step="/addon/xl/de200/electronique-plateau" />
      </Block>
    </Layout>
  );
}

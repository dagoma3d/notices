    ...
    <Layout t={t}>
      ...
      <Section
        ...
        content={[
          ...
          { text: "Ensuite, passez au câblage. pour cela, suivez le guide par ", link: { href: "/printer/de200/notice-cablage", target: "_blank", text: "ici" } },
      ...
      <Block
        ...
        <Validation t={t} step="/firmware/de200/xl" />
      </Block>
    </Layout>
  );
}

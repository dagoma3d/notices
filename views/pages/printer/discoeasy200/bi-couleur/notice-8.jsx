    ...
    render() {
        return (
            <Layout>
                ...
                <nav className="nav-vertical  closed  col-xl-4 row">
                ...
                </nav>        <section className="col-xl-24 notice-mask row">
                    ...
                    <section className="block-caption-classic block-caption-right">
                        ...
                        <p>
                            Nous avons ajouté dans notre dernier cura la possibilité de préparer des gcodes pour la double extrusion. Si vous n’êtes pas familiers de Cura, rendez-vous d’abord
                <a className="link-classic" href="/cura-by-dagoma.html?version=v1">ici.</a>
                        </p>
                    </section>
                </section>
                ...
                <section className="col-xl-24 display-flex block-video height-350 row">
                    ...
                    <section className="col col-xl-12 col-xl-pull-12 col-m-24 col-m-pull-0 row">
                        <div className="block-caption-classic block-caption-left row col-vspace">
                            ...
                            <p>Les fichiers pour imprimer en bi-couleurs sont spécifique, ils doivent être au préalable séparés en deux avec la même origine. Cura peut ensuite les rassembler et les slicers en un seul et même gcode.</p>
                            <p>Nous vous avons préparé un pack de 15 objets pour la bi-couleur.</p>
                            <p className="tleft">
                                <a href="http://media.dagoma.fr/stl/15STL.zip"
                                    className="new-btn btn-classic btn-grey btn-wide" download="15STL.zip">
                ...
                <section className="col-xl-24 display-flex block-video height-350 row">
                    <section className="col col-xl-12 col-m-24 bg-white block-info-cursor row">
                        ...
                        <video className="video-js" preload="auto" width="100%" height="auto"
                            poster="" data-setup="{}">
                            <source src="/medias/DiscoEasy/Add-on/Bicouleur/8-c-choix.mp4" type='video/mp4' />
                            <source src="/medias/DiscoEasy/Add-on/Bicouleur/8-c-choix.ogv" type='video/ogv' />
                            <source src="/medias/DiscoEasy/Add-on/Bicouleur/8-c-choix.webm" type='video/webm' />
                    ...
                    <section className="col col-xl-12 col-m-24 row">
                        <div className="block-caption-classic block-caption-left row col-vspace">
                            ...
                            <p className="tleft">
                                <a href="https://dist.dagoma3d.com/CuraByDagoma" target="_blank"
                                    className="new-btn btn-classic btn-grey btn-wide">
                                    Télécharger
                    </a>
                            </p>
                            <p>Une fois installé, sur l’écran de choix d’imprimante, cliquez sur discoeasy200, choisissez oui pour la double extrusion, et appuyez sur OK.</p>
                ...
                <section className="col-xl-24 display-flex block-video height-350 row">
                    ...
                    <section className="col col-xl-12 col-xl-pull-12 col-m-24 col-m-pull-0 row">
                        <div className="block-caption-classic block-caption-left row col-vspace">
                            ...
                            <p>A - Double extrusion signifie double réglage de filament. Chargez un filament dans l’extrudeur 1 (le numéro d’extrudeur est également repéré sur votre machine) puis choisissez son paramètre. Faites de même pour le second. Nous verrons ensuite comment affecter un filament à un STL.</p>
                            <p>B - Le choix du filament pour le support. Si vous activez le support, vous pouvez choisir un des filaments pour le support uniquement. Nous allons vous montrer l’impact de ce paramètre.</p>
                            <p>C - Le choix du volume de purge. Ce paramètre est très important pour obtenir une pièce propre. Nous vous expliquons tout plus bas.</p>
                        </div>
                    </section>
                </section>
                ...
                <section className="col-xl-24 display-flex block-video height-350 row">
                    ...
                    <section className="col col-xl-12 col-xl-pull-12 col-m-24 col-m-pull-0 row">
                        <div className="block-caption-classic block-caption-left row col-vspace">
                            ...
                            <p>La bi-extrusion offre la possibilité de gérer les supports de différentes façon (bien-sur il faut au préalable activer les supports) :</p>
                            <ul className="lsn tleft-child">
                                <li className="col-hlspace"><p>A. Les deux : Les deux filaments seront utilisés pour faire le support.</p></li>
                                <li className="col-hlspace"><p>B. Filament 1 : Seul le filament 1 sera utilisé pour le support, orange ici.</p></li>
                                <li className="col-hlspace"><p>C. Filament 2 : Seul le filament 2 sera utilisé pour le support, gris ici.</p></li>
                                <li className="col-hlspace"><p>D. Il est possible d’imprimer une pièce monochrome avec un support d’une autre matière. Ici, nous avons imprimé le “T” avec le filament 1 et le support avec le filament 2. Pour se faire, il faut choisir “Filament 2” dans type de support.</p></li>
                            </ul>
                        </div>
                    </section>
                </section>
                ...
                <section className="col-xl-24 display-flex block-video height-350 row">
                    ...
                    <section className="col col-xl-12 col-m-24 row">
                        <div className="block-caption-classic block-caption-left row col-vspace">
                            ...
                            <p>Pour passer d’un filament à l’autre il est nécessaire de purger le restant de couleur présent dans la buse. Ce volume est généralement réglé sur standard.</p>
                            <p>Pour des couleurs proches tel que le blanc et le beige (A), passer sur “Petit (30 mm3)” permet de réduire les pertes sans perdre en qualité.</p>
                            <p>Pour des couleurs très contrastées (C) tel que le beige et le noir, passer sur “Grand (125 mm3)” permet de conserver la qualité, dans ce cas les pertes sont plus importante.</p>

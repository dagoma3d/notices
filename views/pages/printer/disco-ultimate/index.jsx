            ...
            <Layout>
                    ...
                    <div className="col-xl-24 col-vspace row">
                        <div className="container col-xl-24 row col-vspace">
                            <section className="col-xl-24 block-little-space row bg-gradient-orange">
                                <div className="col-xl-12 col-xl-offset-6 col-m-20 col-m-offset-2 col-vspace row">
                                    <div className="dib row col-xl-16 col-xl-offset-4 col-l-20 col-l-offset-2 col-m-24 col-m-offset-0 row">
                                        <input type="text" className="tnormal full-width col-space" size="50"
                                            placeholder="ex: 09-FRRBX-01-0008188"
                                            name="version" />
                                        <div id="response-serial" className="error text-red color-white"></div>
                                        <p className="tleft small italic col-vtspace">
                                            <a className="link-classic btn-sub-step"
                                                data-id="open-disco">
                                                Comment trouver le numéro de série de votre Disco Ultimate ?
                                                                    </a>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-24 block-little-space row">
                                <a
                                    className="new-btn btn-valid btn-big btn-wide btn-valid-options"
                                    href="/start/disco-ultimate/notice-1.html"
                                >
                                    Valider
                    </a>
                                <div className="col-xl-24 col-vtspace row">
                                    <a
                                        className="link-classic tnormal btn-valid-options no-option"
                                        href="/start/disco-ultimate/notice-1.html"
                                    >
                ...
                <section id="condition" className="col-xl-24 block-hidden block-sub row">
                    ...
                    <div className="wrap row">
                        <section className="col-xl-24 display-flex block-video height-350 row">
                            <section className="col col-xl-12 col-m-24 bg-white block-info-cursor row">
                                <figure>
                                    ...
                                    <img className="condition-expert hidden"
                                        src="/medias/DiscoEasy/Add-on/Bicouleur/1-c-prerequis-impression-expert.jpg" />
                                </figure>
                            </section>
                            <section className="col col-xl-12 col-m-24 row">
                                <div className="block-caption-classic block-caption-left row col-vspace">
                                    ...
                                    <p>
                                        <a className="condition-classic new-btn btn-classic btn-grey"
                                            href="http://media.dagoma.fr/stl/stl_bicouleur.zip" download="stl_couleur.zip">
                                            Télécharger
                            </a>
                                        <a className="condition-expert new-btn btn-classic btn-grey hidden"
                                            href="http://media.dagoma.fr/stl/stl_bicouleur.zip" download="stl_couleur.zip">
                                            Télécharger
                            </a>
                                    </p>
                        ...
                        <div className="col-xl-24 block-little-space row">
                            <a className="new-btn btn-valid btn-big btn-wide btn-valid-options btn-condition"

                                href="/start/discoeasy200/bi-couleur/notice-1.html">
                ...
                <section className="col-xl-18 col-xl-offset-3 col-space row">
                    <div id="open-disco" className="block-hidden block-sub row col-xl-24">
                        <div className="col-xl-24 block-white-space">
                            <p className="tcenter bold col-vspace">Le numéro de série se situe sur l'étiquette collée sur le carton du kit, et sous la plaque de protection.</p>
                            <figure className="col-xl-18 col-xl-offset-3 col-l-20 col-l-offset-2 col-m-24 col-m-offset-0 col-space row">
                                <img className="col-xl-24" src="/medias/DiscoUltimate/n-serie-du.jpg" alt="Trouver numéro de série de ma Disco Ultimate" />
                            </figure>
                        </div>
                    </div>
                </section>

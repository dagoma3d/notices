                ...
                <nav className="nav-vertical  closed  col-xl-4 row">
                    ...
                    <div className="col-xl-21 col-xl-offset-3 nav-step-container row">
                        <ul className="notice-step lsn">
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-1.html?version=ultimate-v1">
                                    1 - Préparation
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-2.html?version=ultimate-v1">
                                    2 - Face av.
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-3.html?version=ultimate-v1">
                                    3 - Face ar.
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-4.html?version=ultimate-v1">
                                    4 - Fix. latérales
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-5.html?version=ultimate-v1">
                                    5 - Base
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-6.html?version=ultimate-v1">
                                    6 - Plateau
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-7.html?version=ultimate-v1">
                                    7 - Axe X
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-8.html?version=ultimate-v1">
                                    8 - Axe Z
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-9.html?version=ultimate-v1">
                                    9 - Câblage
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-10.html?version=ultimate-v1">
                                    10 - Finitions
                            <figure>
                            ...
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/firmware/disco-ultimate.html?version=ultimate-v1">
                                    11 - Mise à jour
                        </a>
                            </li>
                            <li className="new-btn btn-classic btn-grey step active">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/calibration.html?version=ultimate-v1">
                                    12 - Calibration
                        </a>
                            </li>
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/logiciels/cura-by-dagoma.html?printer=disco-ultimate&amp;version=ultimate-v1">
                                    13 - Cura
                        </a>
                            </li>
                            <li className="new-btn btn-classic btn-grey step ">
                                <a className="btn-wide btn-big" href="/start/disco-ultimate/notice-utilisation.html?version=ultimate-v1">
                                    14 - Utilisation
                        </a>
                            </li>
                        </ul>
                ...
                <section className="col-xl-24 display-flex height-350 row">
                    <section className="col-xl-12 col-m-24 color-anthracite block-info-cursor row">
                        <figure className="notice-small-img-small">
                            <img src="/medias/DiscoEasy/Calibration/b1-prerequis-du.jpg" alt="" />
                        </figure>
                    </section>
                ...
                <section className="wrap display-flex height-350 row">
                    ...
                    <section className="col-xl-24 row block-video block-video-hidden">
                        ...
                        <video className="video-js" preload="auto" width="100%" height="auto" poster="" data-setup="{}">
                            <source src="/medias/DiscoEasy/Calibration/c-e3-du.mp4" type='video/mp4' />
                            <source src="/medias/DiscoEasy/Calibration/c-e3-du.ogv" type='video/ogv' />
                            <source src="/medias/DiscoEasy/Calibration/c-e3-du.webm" type='video/webm' />
                    ...
                    <div className="col-xl-12 col-xl-offset-6 col-l-18 col-l-offset-3 col-m-24 col-m-offset-0 row col-vspace">
                        <div className="checkbox-classic checkbox-full-width">
                            ...
                            <label className="tnormal valid-step"
                                data-redirect="/start/logiciels/cura-by-dagoma.html?printer=disco-ultimate&amp;version=ultimate-v1" htmlFor="yo">

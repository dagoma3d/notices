    ...
    <Layout t={t}>
      ...
      <Section
        ...
        content={[
          ...
          { text: "Pour plus d'info sur le sens, ", link: { href: "/printer/du/notice-7#du-courroie-x", target: "_blank", classes: "new-btn btn-valid btn-wide btn-big", text: "C'est par ici !" } }
        ]} />
      <Block
        t={t}
        content={[
